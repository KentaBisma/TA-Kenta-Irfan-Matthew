...
def slide_detector_kenta(
        ...
        globality_threshold=GLOBALITY_THRESHOLD,
):
    global VIDEO_NAME, VIDEO_EXT, VIDEO_PATH, dir_name, cap, GAUSSIAN_KERNEL, TIME_THRESHOLD, WHITE_THRESHOLD, GRAY_THRESHOLD, HUE_THRESHOLD, GLOBALITY_THRESHOLD
    ...
    while (True):
        ...
        ui_images["Hue"] = hue
        hue = cv2.GaussianBlur(
            hue, (GAUSSIAN_KERNEL, GAUSSIAN_KERNEL), 0)  # TODO
